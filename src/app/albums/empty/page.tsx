...
export default async function EmptyAlbumsPage() {
  ...
  return (
    <AppShell>
      <h1 className="font-display text-4xl" data-testid="empty-albums-heading">{emptyAlbumsHeading(empty.length)}</h1>
      <ul className="mt-8 space-y-3" data-testid="empty-albums">
        {empty.map((album) => (
          <li key={album.id}>
