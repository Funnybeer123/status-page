  ...
  return (
    <AppShell>
      ...
      <p className="mt-4 font-sans text-sm">
        ...
        {" · "}
        <Link href={`/reunions/${reunion.id}/shop`} className="text-seal" data-testid="shop-link">
          Shopping list
        </Link>
        {" · "}
        ...
        {" · "}
        <Link href={`/reunions/${reunion.id}/tent`} className="text-seal" data-testid="table-tent-link">
          Table tent
        </Link>
        {" · "}
        <Link href={`/reunions/${reunion.id}/shifts`} className="text-seal" data-testid="shifts-link">
          Digitizing shifts
        </Link>
        {" · "}
        <Link href={`/reunions/${reunion.id}/program`} className="text-seal" data-testid="program-link">
          Program
        </Link>
      </p>
